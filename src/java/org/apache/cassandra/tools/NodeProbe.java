...
public class NodeProbe implements AutoCloseable
{
    ...
    protected HintsServiceMBean hhProxy;
    ...
    protected void connect() throws IOException
    {
        ...
        try
        {
            ...
            hhProxy = JMX.newMBeanProxy(mbeanServerConn, name, HintsServiceMBean.class);
    ...
    {
        hhProxy.pauseDispatch();
    }

    public void resumeHintsDelivery()
    {
        hhProxy.resumeDispatch();
    }

    public void truncateHints(final String host)
    {
        hhProxy.deleteAllHintsForEndpoint(host);
    }

    public void truncateHints()
    {
        hhProxy.deleteAllHints();
    }
